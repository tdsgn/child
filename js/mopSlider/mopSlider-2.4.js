...
jQuery.fn.extend({
	mopSlider:function(setting){
		...
		if(mopSliderType=="paper"){
			btnLeft.src="js/mopSlider/sliderBtnLeftW.png";
			btnLeftF.src="js/mopSlider/sliderBtnLeftW_f.png";
			btnRight.src="js/mopSlider/sliderBtnRightW.png";
			btnRightF.src="js/mopSlider/sliderBtnRightW_f.png";
			btnCenter.src="js/mopSlider/sliderBtnW.png";
			btnChange.src="js/mopSlider/sliderBackRightRightW.png";
			btnChangeF.src="js/mopSlider/sliderBackRightRightW_f.png";
			backImg.src="js/mopSlider/paperBack.gif";
			sldcLeftImg.src="js/mopSlider/sliderBackLeftLeftW.png";
			sldcRightImg.src="js/mopSlider/sliderBackRightRightW.png";
			sldBackLeft.src="js/mopSlider/sliderBackLeftW.png";
			sldBackCenter.src="js/mopSlider/sliderBackW.png";
			sldBackRight.src="js/mopSlider/sliderBackRightW.png";
		}else if(mopSliderType=="black"){
			btnLeft.src="js/mopSlider/sliderBtnLeft.png";
			btnLeftF.src="js/mopSlider/sliderBtnLeft_f.png";
			btnRight.src="js/mopSlider/sliderBtnRight.png";
			btnRightF.src="js/mopSlider/sliderBtnRight_f.png";
			btnCenter.src="js/mopSlider/sliderBtn.png";
			btnChange.src="js/mopSlider/sliderBackRightRight.png";
			btnChangeF.src="js/mopSlider/sliderBackRightRight_f.png";
			backImg.src="js/mopSlider/monoBack.gif";
			sldcLeftImg.src="js/mopSlider/sliderBackLeftLeft.png";
			sldcRightImg.src="js/mopSlider/sliderBackRightRight.png";
			sldBackLeft.src="js/mopSlider/sliderBackLeft.png";
			sldBackCenter.src="js/mopSlider/sliderBack.png";
			sldBackRight.src="js/mopSlider/sliderBackRight.png";
		}
...
/*			backImg.src="js/mopSlider/paperBack.gif";*/
		...
		if(mopSliderType!="tutorialzine")
		{
			...
			$(mopSliderName+" .leftTopIn").css({height:"10px",width:"10px",backgroundImage:"url(js/mopSlider/sliderCorner_leftTop.png)",backgroundRepeat:"no-repeat"});
			$(mopSliderName+" .rightTop").css({height:"10px",width:"10px",position:"absolute",top:"0px",right:"0px"});
			$(mopSliderName+" .rightTopIn").css({height:"10px",width:"10px",backgroundImage:"url(js/mopSlider/sliderCorner_rightTop.png)",backgroundRepeat:"no-repeat"});
			$(mopSliderName+" .leftBottom").css({height:"10px",width:"10px",position:"absolute",bottom:"0px",left:"0px"});
			$(mopSliderName+" .leftBottomIn").css({height:"10px",width:"10px",backgroundImage:"url(js/mopSlider/sliderCorner_leftBottom.png)",backgroundRepeat:"no-repeat",backgroundPosition:"bottom"});
			$(mopSliderName+" .rightBottom").css({height:"10px",width:"10px",position:"absolute",bottom:"0px",right:"0px"});
			$(mopSliderName+" .rightBottomIn").css({height:"10px",width:"10px",backgroundImage:"url(js/mopSlider/sliderCorner_rightBottom.png)",backgroundRepeat:"no-repeat",backgroundPosition:"bottom"});
	
			/*logo*/
			$(mopSliderName+" .logo").css({height:"50px",width:"80px",position:"absolute",top:"0px",left:"0px"});
			$(mopSliderName+" .logoIn").css({height:"50px",width:"80px",backgroundImage:"url(js/mopSlider/logo.png)",backgroundRepeat:"no-repeat"});
		}
